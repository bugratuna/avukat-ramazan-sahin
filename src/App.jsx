...
Telefon Numarası: ${userData.phone}`;
    ...
    <div className="min-h-screen bg-rose-50/50 pb-24 font-sans text-gray-900">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 space-y-12">
        ...
        <section className="text-center space-y-2">
          <h2 className="text-3xl font-bold text-gray-800">Ev yapımı, sevgiyle 🌸</h2>
          <p className="text-gray-600 max-w-lg mx-auto">
              Her gün taze pişirilen, gerçek ev yemekleri.
              Beğendiklerinizi seçin, WhatsApp’tan hemen sipariş verin!
          </p>
        </section>
        ...
        <section className="space-y-6">
          <div className="flex items-center gap-2 mb-6">
            <h3 className="text-xl font-bold text-gray-800">Menümüz ✨</h3>
